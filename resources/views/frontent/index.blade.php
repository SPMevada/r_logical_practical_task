          ...
          <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-3 p-md-4 p-xl-5">
              <div class="row">
                <div class="col-12">
                  <div class="mb-5">
                    <h2 class="h3">Frontent Login</h2>
                  </div>
                </div>
              </div>
              <form id="frontentLoginForm" method="POST">
                @csrf
                <div class="row gy-3 overflow-hidden">
                  ...
                  <div class="col-12">
                    <div class="d-grid">
                      ...
                      <a href="{{ route('frontent.register') }}" class="btn bsb-btn-2xl btn-primary mt-3" >Register</a>
                    </div>
                  </div>
                </div>
              </form>
...
@section('script')
    <script type="text/javascript">
      $(document).ready(function() {
          ...
          $(document).on('submit','#frontentLoginForm',function(e) {
              e.preventDefault();

              $.ajax({
                  url: "{{ route('frontent.login') }}",
                  type: "POST",
                  dataType: "JSON",
                  data: $(this).serialize(),
